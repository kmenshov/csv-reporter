...
accounts_list = [
  ...
  %w(2000000029000758 Preferred Customer Family3)
]

merchants_list =[
  %w(18617459 merchant1@example.com Merchant1 10.00),
  %w(215029   merchant2@example.com Merchant2 8.20),
  %w(34008628 merchant3@example.com Merchant3 11.01),
]
